          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><?php if ($liste[$i]->statut == 0): ?> Activer l'article<?php else: ?> Déactiver l'article<?php endif; ?></h4>
              </div>
                   <div class="modal-body">
                    <p> Etes-vous sûre de vouloir <?php if ($liste[$i]->statut == 0): ?> Activer <?php else: ?> Déactiver <?php endif; ?>cet article?</p>
                    </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fermer</button>
              <a href="<?= base_url() ?>blog/statut_article/<?php echo $liste[$i]->id ;?>">  <button type="submit" class="btn btn-outline"><?php if ($liste[$i]->statut == 0): ?> Activer l'article<?php else: ?> Déactiver l'article<?php endif; ?></button>
              </a>
              </div>
            </div>
            <!-- /.modal-content -->
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"> Supprimer l'article</h4>
                   ...
                   <div class="modal-body">
                    <p> Etes-vous sûre de vouloir Supprimer l'article ?</p>
                    </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fermer</button>
              <a href="<?= base_url() ?>blog/delete_article/<?php echo $liste[$i]->id ;?>">  <button type="submit" class="btn btn-outline"> Supprimer l'article</button>
              </a>
              </div>
            </div>
          </div>
