            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"> Supprimer la catégorie</h4>
                   ...
                   <div class="modal-body">
                    <p> Etes-vous sûre de vouloir Supprimer la catégorie ?</p>
                    </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fermer</button>
              <a href="<?= base_url() ?>blog/delete_categorie/<?php echo $liste[$i]->id ;?>">  <button type="submit" class="btn btn-outline"> Supprimer la catégorie</button>
              </a>
              </div>
            </div>
          </div>
