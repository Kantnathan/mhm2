         ...
         <div class="modal  modal-danger fade" id="d<?php echo $liste[$i]->id ;?>">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"> Supprimer le nom de domaine</h4>
              </div>
                   <div class="modal-body">
                    <p> Etes-vous sûre de vouloir Supprimer le nom de domaine ?</p>
                    </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fermer</button>
              <a href="<?= base_url() ?>Hebergement_web_pour_developpeur/delete_domaine/<?php echo $liste[$i]->id ;?>">  <button type="submit" class="btn btn-outline"> Supprimer le nom de domaine</button>
              </a>
              </div>
            </div>
          </div>
          <!-- /.modal-dialog -->
                  ...
                  <a href="<?= base_url() ?>Hebergement_web_pour_developpeur/edit_domaine/<?php echo $liste[$i]->id ;?>"> 
                    <button type="button" class="btn btn-default btn-sm "><i class="fa fa-edit" style="margin-right: 7px;"></i></button>
                  </a>
                  <a href="<?= base_url() ?>Hebergement_web_pour_developpeur/single_domaine/<?php echo $liste[$i]->id ;?>"><button type="button" class="btn btn-default btn-sm "><i class="fa fa-eye" style="margin-right: 7px;"></i></button></a>
