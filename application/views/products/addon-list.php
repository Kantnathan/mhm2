        ...
        <div class="col-xs-12">
         ...
         <div class="alert alert-success alert-dismissible">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><?php if ($liste[$i]->statut == 0): ?> Activer le addon<?php else: ?> Déactiver le addon<?php endif; ?></h4>
              </div>
                   <div class="modal-body">
                    <p> Etes-vous sûre de vouloir <?php if ($liste[$i]->statut == 0): ?> Activer <?php else: ?> Déactiver <?php endif; ?> ce addon?</p>
                    </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fermer</button>
              <a href="<?= base_url() ?>Hebergement_web_pour_developpeur/statut_addon/<?php echo $liste[$i]->id ;?>">  <button type="submit" class="btn btn-outline"><?php if ($liste[$i]->statut == 0): ?> Activer le addon<?php else: ?> Déactiver le addon<?php endif; ?></button>
              </a>
              </div>
            </div>
            <!-- /.modal-content -->
          ...
          <div class="modal  modal-danger fade" id="d<?php echo $liste[$i]->id ;?>">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"> Supprimer le addon</h4>
              </div>
                   <div class="modal-body">
                    <p> Etes-vous sûre de vouloir Supprimer le addon ?</p>
                    </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fermer</button>
              <a href="<?= base_url() ?>Hebergement_web_pour_developpeur/delete_addon/<?php echo $liste[$i]->id ;?>">  <button type="submit" class="btn btn-outline"> Supprimer le addon</button>
              </a>
              </div>
            </div>
          </div>
          <!-- /.modal-dialog -->
                  ...
                  <a href="<?= base_url() ?>Hebergement_web_pour_developpeur/single_addon/<?php echo $liste[$i]->id ;?>"><button type="button" class="btn btn-default btn-sm "><i class="fa fa-eye" style="margin-right: 7px;"></i></button></a>
