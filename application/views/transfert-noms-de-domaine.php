			...
			<div class="row ">
				<div class="col-sm-10 com-md-8 center-block ">
					<form class="form-inline domainsearch clearfix"  method="post" action="#">
						...
						<div class="col-sm-2">
							<button type="submit" class="btn waves-effect waves-light btn-info">Transferer</button>
						</div>
					</form>
				</div>
    ...
    <section class="blogpost-home bg_gray section_space">
	 <div class="row">
		<div class="col-sm-12">
		   <div class="text-center">
			  <h2 class="title">Comment transferer votre nom de domaine</h2>
     ...
     <div class="row">
		   <div class="text-center margin-top-20">
			  <span style="font-size: 30px">Vous n'avez pas encore un nom de domaine? <a href="#" class="btn waves-effect waves-light btn-warning btn-lg ">ENREGISTREZ VOTRE DOMAINE</a></span>
           </div>
    </div>
  </section>
