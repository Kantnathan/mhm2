  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
           <?php if ($this->session->flashdata('ticketMessage') != Null): ?>
          ...
          <div class="modal  modal-danger fade" id="d<?php echo $liste[$i]->id ;?>">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"> Supprimer le ticket</h4>
              </div>
                   <div class="modal-body">
                    <p> Etes-vous sûre de vouloir Supprimer le ticket ?</p>
                    </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fermer</button>
              <a href="<?= base_url() ?>assistance/delete_ticket/<?php echo $liste[$i]->id ;?>">  <button type="submit" class="btn btn-outline"> Supprimer le ticket</button>
              </a>
              </div>
            </div>
          </div>
